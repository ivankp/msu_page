...
nnoremap <silent> <expr> \c ':call DecorateComment('.getchar().')'
noremap \h :noh
...
noremap t<Right> :tabm +1
noremap t<Left> :tabm -1
...
noremap <F10> :call ToggleComplete_it()
nnoremap <F9> :set wrap! wrap?
noremap <silent> <F8> :let &cc = &cc == '' ? '80' : ''
noremap <F5> :call Make()
noremap <silent> <F4> :call MRUToggle()
noremap <F3> :%s/\s\+$//e | :noh
inoremap  
inoremap  
